module Messages
  ...
  # Сообщения появляющиеся при отказе в доступе
  Access={
    :denied=>"Запрашиваемый ресурс не найден или не доступен.<br />Возможно, недостаточно прав доступа.<br />Попробуйте выполнить вход в систему или регистрацию от имени другого пользователя"
  }
