class CreatePages < ActiveRecord::Migration
  def self.up
    create_table :pages do |t|
      ...
      t.text   :annotation
      # Содержимое страницы, Здесь хранится в html формате
      # Редактор использует bbcodes(или чистый html, пока не решено) который при сохранении приводятся к html
      # Система доверительная - поэтому запрещены только спец тегиж: javascript и т.д.
      t.text   :content
