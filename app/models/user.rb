...
# id | role_id | obj_id | obj_type | section | action | value | start_at | finish_at | counter | max_count
#
#
...
# 
# Необходимоа функция безопасного(простого) доступа к элементу массива, что бы не проверять переменную в хеше на сущетвования
